 ...
 */
     ...
     */
        ...
        {
                        return Router::crud($name, $controller);
        }
                    /**
         *
         *
...
')
     ...
     */
         ...
         *
         * @param \Illuminate\View\View|Htmlable|Closure|string $view
         * @param array $data
         * @return void
         * @static
         */
     ...
     */
         ...
         * @return CrudButton The new CRUD button.
         * @static
         */
        ...
        public static function hasMacro($name)
        {
                        return CrudPanel::hasMacro($name);
        }
     ...
     *
     *
     * @method static AlertsMessageBag success(string $text)
     * @method static AlertsMessageBag error(string $text)
     * @method static AlertsMessageBag warning(string $text)
     * @method static AlertsMessageBag info(string $text)
     */
        class Alert {
                    /**
         * Store the messages in the current session.
         *
         * @return AlertsMessageBag
         * @static
         */
        public static function flash()
        {
                        /** @var AlertsMessageBag $instance */
...
namespace  {
    ...
    class App extends \Illuminate\Support\Facades\App {}
            ...
            class MailClient extends MailClientFacade {}
            class UserMail extends UserMailFacade {}
            class SponsorshipMail extends SponsorshipMailFacade {}
            class CRUD extends CrudPanelFacade {}
