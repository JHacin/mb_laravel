...
@section('content')
    <section class="section">
        <div class="container">
            <h1 class="title">Pravila in pogosta vprašanja</h1>
            ...
            <article class="message is-primary">
                ...
                <div class="message-body">
                    <div class="content">
                        <p>Preprosto.</p>
                        <p>
                            Oglejte si muce, ki iščejo botra. Izberite muco in ob njenem imenu kliknite
                            <em>Želiš postati moj boter</em>? Izpolnite in pošljite <strong>Dogovor o posvojitvi na daljavo</strong>.
            ...
            <article class="message is-primary">
                <div class="message-header">Ne morem se odločiti za eno muco. Kaj storiti?</div>
                <div class="message-body">
                    <div class="content">
                        <p>
                        ...
                        <p>
                            Posvojite pa lahko tudi <strong>Bubije</strong>, s čemer nam pomagate pri oskrbi mačjih dudarjev in mladičev
                            ali pa <strong>Pozitivčke</strong>, FeLV (mačja levkoza) in/ali FIV (mačji aids) pozitivne muce brez kliničnih
                            znakov bolezni.
                        </p>
                    </div>
                </div>
            ...
            <article class="message is-primary">
                <div class="message-header">Kako prekiniti dogovor o posvojitvi na daljavo?</div>
                <div class="message-body">
                    <div class="content">
                        <p>
            ...
            <article class="message is-primary">
                <div class="message-header">Kaj dobi boter v zameno za svojo donacijo?</div>
                <div class="message-body">
                    <div class="content">
                        ...
                        <p>
                            Botri lahko postanete tudi član <strong>kluba Super Čombe</strong>. Članstvo v klubu vam ne prinaša nobene obveznosti,
                            imate pa kot član ugodne pogoje pri nakupih v naši spletni trgovini Super Čombe.
                            Za ureditev članstva nam po registraciji v spletni trgovini pišite na <a href="mailto:trgovina@supercombe.si">trgovina@supercombe.si</a>.
                        </p>
                    </div>
                </div>
            </article>
            ...
            <article class="message is-primary">
                <div class="message-header">Za kaj bo porabljen moj denar?</div>
                <div class="message-body">
                   <div class="content">
                       <p>
