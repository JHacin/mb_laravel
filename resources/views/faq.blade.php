  ...
  <div class="mb-page-content-container">
    ...
    <div class="mb-content-offset-l-4 mb-content-offset-r-3">
      <x-faq-item title="Kako postanem mačji boter?">
        <p>
          Preprosto. Oglejte si <a class="mb-link" href="{{ route('cat_list') }}">muce, ki iščejo botra</a>. Izberite muco in ob njenem imenu kliknite
      ...
      <x-faq-item title="Kaj dobi boter v zameno za svojo donacijo?">
        ...
        <p>
          Botri lahko postanete tudi član <strong>kluba Super Čombe</strong>. Članstvo v klubu vam ne prinaša nobene
          obveznosti,
