...
<div class="grid grid-cols-3 gap-7">
    ...
    >
        ...
        <x-slot name="details">
            <x-special-sponsorships.type-card.benefits>
    ...
    >
        ...
        <x-slot name="details">
            ...
            <x-special-sponsorships.type-card.fip></x-special-sponsorships.type-card.fip>
        </x-slot>
    </x-special-sponsorships.type-card>
    ...
    >
        ...
        <x-slot name="details">
            ...
            <x-special-sponsorships.type-card.zobna></x-special-sponsorships.type-card.zobna>
        </x-slot>
    </x-special-sponsorships.type-card>
    ...
    >
        ...
        <x-slot name="details">
            <x-special-sponsorships.type-card.benefits>
                <div>
                    Z botrstvom se za eno leto uvrstite med botre Čombeta (ali drugega mucka, ki je na voljo za
                    botrovanje)
