...
@section('content')
    ...
    <div class="mb-page-content-container">
        <div class="mb-content-offset-l-2 space-y-6 mb-12 md:mb-14 lg:space-y-10 lg:mb-16 xl:space-y-14 xl:mb-20 2xl:space-y-20 2xl:mb-24">
            <x-home.intro-row>
                <x-slot name="title">
                    pomagamo mucam, ki
                    <span class="text-primary">težje najdejo svoj dom.</span>
                </x-slot>
                <x-slot name="body">
                    <div>
            ...
            <x-home.intro-row>
                <x-slot name="title">
                    botrujete lahko
                    <span class="text-primary">na več načinov.</span>
                </x-slot>
                <x-slot name="body">
                    <div>
